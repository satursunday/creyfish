...
INSERT INTO `address_geography` (`GEO_ID`, `GEO_NAME`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
INSERT INTO `address_province` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
CREATE TABLE `users_data` (
  ...
  `house_number` varchar(32) CHARACTER SET utf8 NOT NULL,
  `moo` int(8) NOT NULL,
  `village` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `soi` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
